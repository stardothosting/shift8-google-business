...
You can check out our demos or contact us at [Shift8web](https://shift8web.ca) for more information and live examples.
...
1. **Admin Settings Page** – Configure your Google API key and add one or more Place IDs in the Shift8 Business settings.
